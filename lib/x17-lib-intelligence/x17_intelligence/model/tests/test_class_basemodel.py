...
class DummyInterface:
    def __init__(self):
        self.log_group = LogGroup(name="DummyInterfaceLogGroup", sync=True)


def test_base_model_log():
    log_group = LogGroup(name="DummyInterfaceLogGroup", sync=True)
...
def test_model_log_without_interface():
    ...
    log_group = LogGroup(name="NoInterfaceLogGroup", sync=True)
...
def test_model_custom_log_stream():
    custom_group = LogGroup(name="CustomGroup", sync=True)
