...
import boto3
from x17_base.aws.ec2.client import Ec2Client
...
@patch("x17_base.aws.ec2.client.Ec2Client.get_security_group_by_name")
...
@patch("x17_base.aws.ec2.client.Ec2Client.get_security_group")
