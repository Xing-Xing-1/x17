...
def test_sample_file_copy_force(sample_file_instance):
	...
	assert copy_file_instance.exists == True
	assert copy_file_instance.read() == 'hello world'
	copy_file_instance = sample_file_instance.copy('tests/env/sample_copy.txt', force=True)
	assert copy_file_instance.exists == True
	assert copy_file_instance.read() == 'hello world'
	copy_file_instance.delete()
...
def test_sample_file_move(sample_file_instance):
	move_file_instance = sample_file_instance.copy('tests/env/sample_move.txt', force=True)
...
def test_sample_file_delete(sample_file_instance):
	delete_file_instance = sample_file_instance.copy('tests/env/sample_delete.txt', force=True)
...
def test_sample_file_rename(sample_file_instance):
	rename_file_instance = sample_file_instance.copy('tests/env/sample_rename.txt', force=True)
