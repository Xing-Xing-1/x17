...
def test_class_plus(sample_text):
    assert sample_text + text(" I am fine.") == text(
        "Hey there! How are you? I am fine."
    )
...
def test_instance_as_digest(sample_text):
    ...
    sample_hash = text(
        "24a1abfc554fea61a127b88d8e3206183c0154ae0fa976d31d975e59fd269e97"
    )
