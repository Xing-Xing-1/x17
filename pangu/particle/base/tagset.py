...
class BaseTagSet:
    ...
    def update(self, key: Union[str, Dict[str, Union[str, int]]], value: Optional[Union[str, int]] = ''):
    ...
    def insert(self, key: Union[str, Dict[str, Union[str, int]]], value: Union[str, int] = ''):
        if isinstance(key, dict):
            for k, v in key.items():
                self.set[k] = v
        else:
